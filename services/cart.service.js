const Cart = require('../models/index').Cart;                      // All this 3 models file require here
const Product = require('../models/index').Product;                // We fetch it through index.js file from module folder
